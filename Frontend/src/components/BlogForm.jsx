         ...
         <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-xl shadow-xl w-[60%]">
               ...
               <form onSubmit={(e)=>{e.preventDefault();handleSubmit();}} >
                  ...
                  <div className="py-[1%]">
                     <input type="text" placeholder="Title" className="w-[100%] border border-custom-gray-1 rounded-lg py-[1.5%] px-[1%] outline-none text-gray-700 focus:outline-none focus:border-custom-blue" value={title} onChange={(e)=>{setTitle(e.target.value.trim())}} required></input>
                  </div>
                  <div className="pl-[0.5%] pt-[2%] font-normal text-[150%]">
                     Write your blog:<span className="text-red-500">*</span>
                  </div>
                  <div className="py-[1%]">
                     <textarea type="text" placeholder="Content" className="w-[100%] h-[40vh] border border-custom-gray-1 rounded-lg py-[1.5%] px-[1%] outline-none text-gray-700 focus:outline-none focus:border-custom-blue" value={blogContent} onChange={(e)=>{setblogContent(e.target.value.trim())}} required></textarea>
                  </div>
